...
//-----------------------------------
#ifndef LANG_FILE
#define LANG_FILE                  "text_res-UA.h"            // Языковой файл по дефолту
#endif
...
#ifndef SPEED_ADJ
#define SPEED_ADJ (float)NUM_LEDS/256                         //256 Поправка скорости риал-тайм эффектов относительно размеров метрицы.
#endif
